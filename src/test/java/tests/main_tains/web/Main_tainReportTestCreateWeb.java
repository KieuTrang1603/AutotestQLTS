...
public class Main_tainReportTestCreateWeb extends BaseTestWeb {
    ...
    @Test(priority = 1)
    public void testCreateAllocation_emptyNgayBaoSuCo(){
        reportWeb.clearNgayBaoCao();
        ...
        Assert.assertTrue(reportWeb.empty(1),
                "Thông báo lỗi không nằm ngay bên dưới ô Ngày chứng từ!");
    }
    @Test(priority = 2)
    public void testCreateAllocation_emptyPhongBaoSuCo(){
        reportWeb.setNgayBaoCaoInput(MyUtil.getNgaychungtu());
        reportWeb.clearPhongBaoSuCo();
        reportWeb.chonPhongTiepNhanInput();
        reportWeb.setLuu_btn();
        // Kiểm tra xem thông báo lỗi có hiển thị không
        Assert.assertTrue(reportWeb.isErrorMessageDisplayed(),
        ...
        // Kiểm tra hiển thị dưới thông báo
        Assert.assertTrue(reportWeb.empty(2),
    ...
    @Test(priority = 4)
    public void testCreateAllocation_emptyNguoiBaoCao(){
        reportWeb.setNgayBaoCaoInput(MyUtil.getNgaychungtu());
        reportWeb.chonPhongBaoSuCoInput();
        reportWeb.chonPhongTiepNhanInput();
        reportWeb.clearNguoiBaoSuCo();
        ds.chonTSCD();
        reportWeb.setLuu_btn();
        // Kiểm tra xem thông báo lỗi có hiển thị không
        Assert.assertTrue(reportWeb.isErrorMessageDisplayed(),
        ...
        // Kiểm tra hiển thị dưới thông báo
        Assert.assertTrue(reportWeb.empty(4),
                "Thông báo lỗi không nằm ngay bên dưới ô Phòng ban tiếp nhận!");
